...
from app.shared.money import entero_a_cantidad, entero_a_precio, precio_a_entero
...
def _validar_datos(codigo: str, categoria_id: int, precio_costo: Decimal, precio_venta: Decimal) -> None:
    if not codigo.strip():
...
def crear_producto(
    ...
    codigo = codigo.strip()
    _validar_datos(codigo, categoria_id, precio_costo, precio_venta)
